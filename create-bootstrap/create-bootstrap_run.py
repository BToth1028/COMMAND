"""DRAFT — validate BOOTSTRAP handoff; no bootstrap-start execution."""
...
REQUIRED_FROZEN = ("project_name", "project_root_absolute")
DRAFT_EXIT = 2
        ...
        json.dumps(
            {
                ...
                "message": "Draft child: bootstrap-start not invoked",
